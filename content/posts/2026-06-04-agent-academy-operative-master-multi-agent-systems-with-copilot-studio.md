...
Operative is available through the **Microsoft Learn platform**. To get started, visit the [Agent Academy: Operative page](https://devblogs.microsoft.com/powerplatform/announcing-agent-academy-operative/) and enroll in the course.
